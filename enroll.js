...
rl.question("Academic Year ? ", function (year) {
  rl.question("course ? ", function (program) {
    rl.question("dept ?", function (dept) {
      var sql = `select ems.cand_admission_details.cand_id,ems.cand_admission_details.cand_name,
          ems.cand_profile_details.father_name,ems.cand_profile_details.mother_name from ems.cand_admission_details
          inner join ems.cand_profile_details on ems.cand_admission_details.cand_id = ems.cand_profile_details.cand_id
      ...
      db_new.query(sql, (err, data) => {
        ...
        // bsc
          ...
          else if((dept.toUpperCase() == "B.SC. CARDIO PULMONARY PERFUSION CARE TECHNOLOGY")){
            course = "02";
            department = "002";
          }
          ...
          else if((dept.toUpperCase() == "B.SC. ACCIDENT AND EMERGENCY CARE TECHNOLOGY")){
            course = "02";
            department = "004";
          }
          ...
          else if((dept.toUpperCase() == "B.SC. OPERATION THEATRE AND ANAESTHESIA TECHNOLOGY")){
            course = "02";
            department = "008";
          }
          ...
          else if((dept.toUpperCase() == "B.SC. RADIOGRAPHY AND IMAGING TECHNOLOGY")){
            course = "02";
            department = "010";
          }else{null}
        }
        //mdms
          ...
          else if((dept.toUpperCase() == "MD DERMATOLOGY,VENEROLOGY & LEPROSY")){
            course = "03";
            department = "004";
          }
          ...
          else if((dept.toUpperCase() == "MD IMMUNO-HAEMATOLOGY & BLOOD TRANFUSION")){
            course = "03";
            department = "007";
          }
          ...
          if((dept.toUpperCase() == "DM CARDIOLOGY")){
            ...
            course = "06";
            department = "002";
          }else if((dept.toUpperCase() == "M.CH PLASTIC AND RECONSTRUCTIVE SURGERY")){
            course = "06";
            department = "003";
        ...
        for (j in myobj_data) { console.log(Number(j)+1);
          var sql = `update ems.cand_admission_details set student_code= '${myobj_data[j].student_code}' where cand_id = '${myobj_data[j].cand_id}'`;
          db_new.query(sql, (err, data) => {
            if (err) {
              console.log(err);
            }
